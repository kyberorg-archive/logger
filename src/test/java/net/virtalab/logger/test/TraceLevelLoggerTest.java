 ...
 * Tests
 */
public class TraceLevelLoggerTest {
    private LogLevel level = LogLevel.TRACE;
    private String prefix = "Trace Logger";
    ...
    public void trace(){
        ...
        log.trace(message);
        String expectedLine = "["+ Color.CYAN+prefix+Color.RESET+"] ("+Color.CYAN+"TRACE"+Color.RESET+") "+message;
    ...
    public void debug(){
        ...
        log.debug(message);
        String expectedLine = "["+ Color.GREEN+prefix+Color.RESET+"] ("+Color.GREEN+"DEBUG"+Color.RESET+") "+message;
        String actualLine = stdOut.toString().trim();
        Assert.assertEquals(expectedLine, actualLine);
    }
